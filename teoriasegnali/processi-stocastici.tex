...
Una definizione di stazionarietà meno restrittiva e più semplice da verificare: un processo aleatorio $X(t)$ è \textsc{stazionario in senso lato}\index{processo stazionario!in senso lato} se
\begin{equation}
