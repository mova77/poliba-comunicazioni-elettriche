...
Se $E_s < \infty$, $s$  si definisce segnale ad \textsc{energia finita} o \textsc{segnale di energia}\index{segnale!di energia}.
...
Se $P_s<+\infty$, $s$ si definisce segnale a \textsc{potenza finita} oppure \textsc{segnale di potenza}\index{segnale!di potenza}.
